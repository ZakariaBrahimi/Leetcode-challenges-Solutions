        ...
        def dfs(row, col):
            ...
            while stack:
                ...
                if not (current_row < 0 or current_row >= rows or
                    ...
                    stack.append((current_row-1, current_col))   # top direction
                    stack.append((current_row+1, current_col))   # down direction
                    stack.append((current_row,   current_col-1)) # right direction
                    stack.append((current_row,   current_col+1)) # left direction
